...
namespace MamiesModGeckoTest
{
    public partial class MamiesModGeckoTestForm : Form
    {
        ...
        {
            string text1 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x4C);
            string text2 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x50);
            string text3 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x54);
            string text4 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x58);
            string text5 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x5C);
            string text6 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x60);
            string text7 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x64);
            string text8 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x68);
            string text9 = MamiesModGecko.peekStringUTF16(MamiesModGecko.peek(0x10AD1C58) + 0x68);
            nintendoNetwork = (text1 + text2 + text3 + text4 + text5 + text6 + text7 + text8 + text9).Replace("\0", "");
        }
        #endregion
        #endregion
